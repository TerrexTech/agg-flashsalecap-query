...
import (
	...
	"github.com/TerrexTech/agg-flashsalecap-query/flashsale"
	...
	Describe("Flashsale Operations", func() {
		It("should query record", func(done Done) {
			...
			queryArgs := map[string]interface{}{
				"flashsaleID": "a08c2f85-150d-41a0-a2b9-567a1d268cee",
			}
